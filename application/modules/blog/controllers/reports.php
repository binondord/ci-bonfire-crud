...
{
    protected $permissionCreate = 'Blog.Reports.Create';
    protected $permissionDelete = 'Blog.Reports.Delete';
    protected $permissionEdit   = 'Blog.Reports.Edit';
    protected $permissionView   = 'Blog.Reports.View';
